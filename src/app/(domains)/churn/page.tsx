        ...
        <div className="space-y-6 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="bg-card border-border transition-colors duration-300">
              ...
              <CardContent>
                <div className="text-[10px] text-muted-foreground">{t("churn_rate_desc")}</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-border transition-colors duration-300">
              ...
              <CardContent>
                <div className="text-[10px] text-muted-foreground">{t("nps_desc")}</div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="p-4 bg-violet-500/10 border border-violet-500/20 rounded-lg text-sm text-foreground flex gap-3">
            ...
            <div>
              <strong className="text-violet-500 block mb-1">{t("auto_insight")}</strong>
              {churnSimulated 
                ? t("insight_critical_churn")
                : t("insight_stable_churn")}
            </div>
          </div>

          <AlertThresholdSettings
            domain="churn"
            title={t("limit_lifetime_rul") || "Limiar de Risco de Churn (Evasão)"}
            min={0}
            max={100}
            unit="%"
                          ...
                          {isExpanded && (
                            <div className="px-4 pb-4 pt-1 bg-muted/10 border-t border-border/50 animate-in slide-in-from-top-2">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                <div>
                                  <div className="text-[10px] text-muted-foreground font-semibold uppercase mb-1">{t("risk_factors")}</div>
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center justify-between bg-background p-2.5 rounded border border-border/60">
                                    ...
                                    <Button size="sm" variant="ghost" className="h-6 text-[10px]">Assign Task</Button>
                                  </div>
                                </div>
                              </div>
                            </div>
